...
const DecorationsCategoryPage = () => {
  ...
  const subcategories = {
    'deco-accessoires': ['Pieces artistiques', 'Vases', 'Statues & Figurines', 'Cadres & Photos'],
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-2">
              {categorySubcategories.map((sub) => (
                <Link
                  key={sub}
                  href={`/decorations/${categoryStr}/${sub.toLowerCase().replace(/\s+/g, '-')}`}
...
export default DecorationsCategoryPage;
