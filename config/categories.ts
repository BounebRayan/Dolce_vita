...
export const homepageCategories: HomepageCategory[] = [
  ...
  { id: 2, link: "/collections", name: 'Collections', image: '/images/categories/collections.jpg', showInHomepage: true, order: 2 },
  ...
  { id: 8, link: "/categories/consoles-meubles-entree", name: 'Commodes & Consoles', image: '/images/categories/consoles.jpg', showInHomepage: true, order: 8 },
  { id: 9, link: "/categories/consoles-meubles-entree", name: 'Meubles d\'Entrée', image: '/images/categories/meubles-entree.jpg', showInHomepage: true, order: 9 },
  { id: 11, link: "/categories/accessoires-deco", name: 'Accessoires déco', image: '/images/categories/accessoires-deco.jpg', showInHomepage: true, order: 11 },
  { id: 12, link: "/categories/pieces-artistiques", name: 'Pieces artistiques', image: '/images/categories/pieces-artistiques.jpg', showInHomepage: true, order: 12 },
  { id: 13, link: "/categories/vases", name: 'Vases', image: '/images/categories/vases.jpg', showInHomepage: true, order: 13 },
  { id: 14, link: "/categories/statues-figurines", name: 'Statues & Figurines', image: '/images/categories/statues.jpg', showInHomepage: true, order: 14 },
  { id: 15, link: "/categories/cadres-photos", name: 'Cadres & Photos', image: '/images/categories/cadres-photo.jpg', showInHomepage: true, order: 15 },
  { id: 16, link: "/categories/bougies-parfums-interieur", name: "Bougies & parfums d'intérieur", image: '/images/categories/bougie.jpg', showInHomepage: true, order: 16 },
  { id: 17, link: "/categories/miroirs", name: 'Miroirs', image: '/images/categories/mirroirs.jpg', showInHomepage: true, order: 17 },
  { id: 18, link: "/categories/decorations-murales", name: 'Déco murale', image: '/images/categories/decorations-murales.jpg', showInHomepage: true, order: 18 },
  { id: 19, link: "/categories/luminaires", name: 'Luminaires', image: '/images/categories/luminaires.jpg', showInHomepage: true, order: 19 },
  { id: 20, link: "/categories/plantes", name: 'Plantes & Fleurs', image: '/images/categories/plantes.jpg', showInHomepage: true, order: 20 },
  { id: 21, link: "/categories/art-de-la-table", name: 'Art de la Table', image: '/images/categories/art-de-la-table.jpg', showInHomepage: true, order: 21 },
  { id: 22, link: "/categories/linge-de-maison", name: 'Linge de maison', image: '/images/categories/linge-de-maison.jpg', showInHomepage: true, order: 22 },
];
