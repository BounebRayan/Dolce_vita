...
export const homepageCategories: HomepageCategory[] = [
  ...
  { id: 11, link: "/categories/accessoires-deco/vases", name: 'Vases', image: '/images/categories/vases.jpg', showInHomepage: true, order: 11 },
  { id: 12, link: "/categories/accessoires-deco/statues-figurines", name: 'Statues & Figurines', image: '/images/categories/statues.jpg', showInHomepage: true, order: 12 },
  { id: 13, link: "/categories/accessoires-deco/cadres-photos", name: 'Cadres & Photos', image: '/images/categories/cadres-photo.jpg', showInHomepage: true, order: 13 },
